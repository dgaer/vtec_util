...
var layer3 = [G_HYBRID_MAP.getTileLayers()[0],G_HYBRID_MAP.getTileLayers()[1],tileCounty];

var custommap1 = new GMapType(layer1, G_HYBRID_MAP.getProjection(), "WMS 3", G_HYBRID_MAP);
var custommap2 = new GMapType(layer2, G_HYBRID_MAP.getProjection(), "WMS 2", G_HYBRID_MAP);
var custommap3 = new GMapType(layer3, G_HYBRID_MAP.getProjection(), "WMS 1", G_HYBRID_MAP);
...
function createWMSSpec(wmsURL, gName, gShortName, wmsLayers, wmsStyles, wmsFormat, wmsVersion, wmsBgColor, wmsSrs) {
	...
	var mapType = new GMapType(layer, G_HYBRID_MAP.getProjection(), gName, G_HYBRID_MAP);
