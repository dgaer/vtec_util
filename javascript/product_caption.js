...
function CaptionOn(evt, num, title, zonenumber, zonename) {
  ...
  if(CaptionIE4 || CaptionIE5 || CaptionFireFox) {
    ...
    mytitle = fontstarttitle + title + '<br />Important Note: Worded expressions describe the expected impact relative to the latest forecast conditions, while Graphic expressions convey the potential impact relative to the uncertainty of forecast conditions.<br />' + zonenumber + ' <strong>' + zonename + '</strong>' + fontendtitle;
    if(CaptionDebug) {	
